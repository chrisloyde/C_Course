/*
Assignment 8
C Programming IO File Project

Performs several file I/O functions for the supplied "data.txt" file.
User is given 4 options
S - searches for a word, displays entire file content with the found words in brackets []. 
	At the end print the number of occurences.
L - Display specified number of text lines to the screen.
A - Append new content to the file. Ask user to type anything to be appended to the end of the current file
	which then permenantly adds user enty to the file.
Q - Quits the program.
*/
