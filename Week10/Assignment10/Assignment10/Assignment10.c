...
Exercise 6:
	Create Macro DISP(f,x), where f is a function and x is a parameter for that function.
	macro should call printf and display the value of function when called with argument x.
	Create DISP2(f,x,y) which works the same as DISP(f,x) except for functions with 2 parameters.
Exercise 9:
	Define the following macros:
	a. CHECK(x,y,n) - Has the value 1 if both x and y fall between 0 and n-1 inclusive.
	b. MEDIAN(x,y,z) - Finds the median between x,y,and z.
